...
from models import CNNs, vision_transformer, mamba, ViTDGCN, FDGC
from models import SSFTTnet, morphFormer
from models import S2ENet, FusAtNet, SHNet, heads
...
if args.backbone in args.MMISO or args.backbone in args.MMIMO:
    ...
    or args.backbone in args.SSISO2:
...
args.result_dir = os.path.join("/home/icclab/Documents/lqw/Multimodal_Classification/MultiModal/result",
...
if args.backbone in args.SSISO:
    test_losses, test_preds, correct, targets = \
        tester.linear_test_SD_SSISO(model, super_head, criterion, val_loader, args)
elif args.backbone in args.SSISO2:
    test_losses, test_preds, correct, targets = \
        tester.linear_test_SD_SSISO2(model, criterion, val_loader, args)
...
if args.backbone in args.SSISO:
    tester.linear_visualation_SD_SSISO(model, super_head, data_loader, args, groundTruth=GT, visulation=True)

elif args.backbone in args.SSISO2:
    tester.linear_visualation_SD_SSISO2(model, data_loader, args, groundTruth=GT, visulation=True)
